...
class Crypto extends React.Component {
  ...
  componentDidMount(){
    ...
    script.src = "https://static.zdassets.com/ekr/snippet.js?key=677eb473-4e9a-48d4-a123-e4b25522f951";
    ...
    <Auxiliary>
      <Row>
        <Col xl={6} lg={12} md={12} sm={12} xs={24}>
          <ChartCard prize="111.27" title="23" icon="bitcoin"
                     ...
                     styleName="up" desc="AUD/NSD"/>
        </Col>
        <Col xl={6} lg={12} md={12} sm={12} xs={24}>
          <ChartCard prize="120.27" title="07" icon="etherium"
                     children={<ResponsiveContainer width="100%" height={75}>
                       <AreaChart data={increamentData}
                                  margin={{top: 0, right: 0, left: 0, bottom: 0}}>
                         <Tooltip/>
                     ...
                     styleName="up" desc="USDJPY"/>
        </Col>
        <Col xl={6} lg={12} md={12} sm={12} xs={24}>
          <ChartCard prize="120.27" title="08" icon="ripple"
                     children={<ResponsiveContainer width="100%" height={75}>
                       <AreaChart data={increamentData}
                                  margin={{top: 0, right: 0, left: 0, bottom: 0}}>
                         <Tooltip/>
                     ...
                     styleName="down" desc="USDGPY"/>
        </Col>
        <Col xl={6} lg={12} md={12} sm={12} xs={24}>
          <ChartCard prize="120.27" title="47" icon="litcoin"
                     children={<ResponsiveContainer width="100%" height={75}>
