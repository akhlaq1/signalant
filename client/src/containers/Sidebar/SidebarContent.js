...
class SidebarContent extends Component {
  ...
  render() { 
    ...
    const {themeType, navStyle, pathname, openTour, isShowingMore, toggleShowMore} = this.props;
    ...
    return (
      <Auxiliary>
        ...
        <div className="gx-sidebar-content">
          <div className={`gx-sidebar-notifications ${this.getNoHeaderClass(navStyle)}`} data-tut="reactour__iso">
            <UserProfile />
            <AppsNavigation/>
          </div>
          <CustomScrollbars className="gx-layout-sider-scrollbar">
            ...
            { 
              ...
              <Menu defaultOpenKeys={[defaultOpenKeys]}
                    ...
                    mode="inline"
                    >
                  <Menu.Item key="main/admindashboard/dashboard">
                    <Link to="/main/admindashboard/dashboard">
                      <i className="icon icon-dasbhoard"/>
                      <IntlMessages id="sidebar.dashboard.admindashboard"/>
                    </Link>
                  </Menu.Item>

                  <Menu.Item key="components/customercrm/data">
                    <Link to="/components/customercrm/data">
                      <i className="icon icon-table"/>
                      <IntlMessages id="sidebar.view.customerTable"/>
                    </Link>
                  </Menu.Item>

                  <Menu.Item key="components/packages/display-package">
                    <Link to="/components/packages/display-package">
                      <i className="icon icon-widgets"/>
                      <IntlMessages id="sidebar.extraElements.packages"/>
                    </Link>
                  </Menu.Item>

                  <Menu.Item key="components/billing/invoice">
                   <Link to="/components/billing/invoice">
                      <i className="icon icon-editor"/>
                      <IntlMessages id="sidebar.view.Billing"/>
                    </Link>
                  </Menu.Item>
            ...
            { 
              ...
              <Menu defaultOpenKeys={[defaultOpenKeys]}
                  ...
                  <Menu.Item key="main/traderdashboard/dashboard" data-tut="reactour__action">
                    <Link to="/main/traderdashboard/dashboard">
                      <i className="icon icon-dasbhoard"/>
                      <IntlMessages id="sidebar.dashboard.traderdashboard"/>
                    </Link>
                  </Menu.Item>

                  <Menu.Item key="components/signals/create-signals" data-tut="reactour__logo">
                   <Link to="/components/signals/create-signals">
                     <i className="icon icon-chart-line"/>
                     Signals
                     {/* <IntlMessages id="sidebar.view.signals"/> */}
                   </Link>
                 </Menu.Item>

                 <Menu.Item key="components/signals/manage-signals" data-tut="reactour__style">
                  <Link to="/components/signals/manage-signals">
                  ...
                  <Menu.Item key="custom-views/packages/pricing" data-tut="reactour__goTo">
                 ...
                 <Menu.Item key="components/newsLetters/subcribe">
                  ...
                  <Menu.Item key="social-apps/profile" data-tut="reactour__scroll--hidden">
                    <Link to="/social-apps/profile">
                      <i className="icon icon-profile2"/>
                      <IntlMessages id="sidebar.extensions.profile"/>
                    </Link>
